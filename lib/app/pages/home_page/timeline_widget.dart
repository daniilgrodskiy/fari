        ...
        child: AnimatedContainer(
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                Text(
                  DateFormat.MMMM().format(currentDate).substring(0, 3),
                  style: Theme.of(context).textTheme.headline6.copyWith(
                    color: isSameDay(currentDate, model.selectedDate) ? Colors.white : Colors.black54,
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.headline6.copyWith(
                    color: isSameDay(currentDate, model.selectedDate) ? Colors.white : Colors.black,
                    fontWeight: FontWeight.w500,
                    fontSize: 20.0,
                  ),
                ),
                ...
                SizedBox(height: 5.0,),
                tasksPerDay[DateTime(currentDate.year, currentDate.month, currentDate.day)] != null 
                  ? Container(
                      height: 5.0,
                      width: 5.0,
                      decoration: BoxDecoration(
