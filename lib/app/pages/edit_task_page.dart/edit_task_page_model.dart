...
class EditTaskPageModel extends ChangeNotifier {
  ...
  void updateCategoryId(String categoryId) => updateWith(categoryId: categoryId);
  ...
  // ToggleModel methods
  void toggleShowDescription() => updateWith(toggleModel: new ToggleModel(showDescription: !toggleModel.showDescription));

  void toggleShowCategories() => updateWith(toggleModel: new ToggleModel(showCategories: !toggleModel.showCategories));

  void toggleShowDay() => updateWith(toggleModel: new ToggleModel(showDay: !toggleModel.showDay));

  void toggleShowTime() => updateWith(toggleModel: new ToggleModel(showTime: !toggleModel.showTime));
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      Task savedTask = new Task(
        id: id,
        name: name,
        description: toggleModel.showDescription ? (description == null || description == "" ? null : description) : null ,
        categoryId: toggleModel.showCategories ? (categoryId == null || categoryId == "" ? null : categoryId) : null,
