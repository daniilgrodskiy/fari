...
import 'custom_weekday_row.dart';
...
/// [isSelectable] - is between [CustomCalendarCarousel.minSelectedDate] and [CustomCalendarCarousel.maxSelectedDate]
...
/// Example: if the user provided [CustomCalendarCarousel.todayTextStyle] and [isToday] is true,
///   [CustomCalendarCarousel.todayTextStyle] would be sent into [DayBuilder]'s [textStyle]. If user didn't
///   provide it, default [CustomCalendarCarousel]'s textStyle would be sent. Same applies to all text styles like
///   [CustomCalendarCarousel.prevDaysTextStyle], [CustomCalendarCarousel.daysTextStyle] etc.
...
class CustomCalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  CustomCalendarCarousel({
    ...
    this.weekDayFormat = CustomWeekdayFormat.short,
...
class _CalendarState<T extends EventInterface> extends State<CustomCalendarCarousel<T>> {
  ...
  @override
  void didUpdateWidget(CustomCalendarCarousel<T> oldWidget) {
